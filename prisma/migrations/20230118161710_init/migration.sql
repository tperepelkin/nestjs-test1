...
CREATE TABLE `individual` (
    ...
    `patronimyc` VARCHAR(150) NOT NULL,
    `passportSeries` CHAR(4) NOT NULL,
    `passportNumber` CHAR(6) NOT NULL,
    `address` VARCHAR(400) NOT NULL,
    `passportSource` VARCHAR(400) NOT NULL,
    `actorId` INTEGER NULL,
...
CREATE TABLE `aircraft` (
    ...
    `aircraftNumber` VARCHAR(191) NULL,
...
CREATE TABLE `Permission` (
    ...
    UNIQUE INDEX `Permission_number_key`(`number`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- CreateTable
CREATE TABLE `_permission_actor` (
    `A` INTEGER NOT NULL,
    `B` INTEGER NOT NULL,

    UNIQUE INDEX `_permission_actor_AB_unique`(`A`, `B`),
    INDEX `_permission_actor_B_index`(`B`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `_permission_actor` ADD CONSTRAINT `_permission_actor_A_fkey` FOREIGN KEY (`A`) REFERENCES `actor`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `_permission_actor` ADD CONSTRAINT `_permission_actor_B_fkey` FOREIGN KEY (`B`) REFERENCES `Permission`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
